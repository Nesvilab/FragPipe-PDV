...
public class AnnotationSettingsDialog extends JDialog {
    ...
    private JComboBox toleranceUnitJComboBox;
     ...
     */
    public AnnotationSettingsDialog(SpectrumMainPanel spectrumMainPanel, SearchParameters searchParameters) {
        ...
        neutralLossList = IonFactory.getNeutralLosses(searchParameters.getPtmSettings());
        initComponents();
        setUpGUI();
    ...
    private void setUpGUI() {
        ...
        if(searchParameters.getFragmentAccuracyType() ==  SearchParameters.MassAccuracyType.DA){
            toleranceUnitJComboBox.setSelectedIndex(0);
        }else {
            toleranceUnitJComboBox.setSelectedIndex(1);
        }
    ...
    private void initComponents() {
        ...
        toleranceUnitJComboBox.setModel(new DefaultComboBoxModel(new String[]{"Da", "ppm"}));
        toleranceUnitJComboBox.setMaximumSize(new Dimension(50, 20));
        toleranceUnitJComboBox.setBackground(Color.WHITE);
                        ...
                        .addGroup(annotationLevelJPanelLayout.createSequentialGroup()
                                ...
                                .addGroup(annotationLevelJPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                                        .addGroup(annotationLevelJPanelLayout.createSequentialGroup()
                                                ...
                                                .addGap(30,100,1000)
                                                .addComponent(fragmentIonAccuracyJLabel)
                                                .addComponent(fragmentIonAccuracyTxt)
                                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(toleranceUnitJComboBox)))
                                .addContainerGap())
        );
    ...
    private void okButtonActionPerformed(ActionEvent evt) {
        double fragmentIonMZTolerance = 20;
        if(!Objects.equals(fragmentIonAccuracyTxt.getText(), "") && fragmentIonAccuracyTxt.getText() != null){
            fragmentIonMZTolerance = Double.parseDouble(fragmentIonAccuracyTxt.getText());
        }

        if(toleranceUnitJComboBox.getSelectedIndex() == 0){
