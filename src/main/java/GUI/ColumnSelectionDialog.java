...
public class ColumnSelectionDialog extends JDialog{
     ...
     */
    public ColumnSelectionDialog(GUIMainClass guiMainClass, JTable spectrumJTable, ArrayList<String> columnName, Boolean proteinOrPSM){
    ...
    private void columnSelectionJTableMouseReleased(MouseEvent evt){
        ...
        if (selectedRows != null) {
            ...
            if (proteinOrPSM){
                guiMainClass.proteinColumnToSelected = columnToSelected;
            } else {
                guiMainClass.pSMColumnToSelected = columnToSelected;
            }
