...
public class ExportExpectedSizeDialog extends JDialog {
    ...
    private void exportJButtonActionPerformed(ActionEvent evt) {
        ...
        File imageFile = new File(outputFolder + GUIMainClass.FILE_SEPARATOR + FilePattern.matcher(spectrumKey).replaceAll("")+ finalImageType.getExtension());
