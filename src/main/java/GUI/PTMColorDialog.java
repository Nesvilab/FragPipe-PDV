...
public class PTMColorDialog extends JDialog {
     ...
     */
    public PTMColorDialog(GUIMainClass guiMainClass, PTMFactory ptmFactory, ArrayList<String> allModification) {
        ...
        setLocationRelativeTo(guiMainClass.settingColorJButton);
        setVisible(true);
    }
    ...
    private void okJButtonActionPerformed(ActionEvent evt){
        ...
        SearchParameters searchParameters = guiMainClass.searchParameters;
        searchParameters.setPtmSettings(ptmSettings);

        guiMainClass.setSearchParameters(searchParameters);

        guiMainClass.updateTable();
